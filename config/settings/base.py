...
)  # (django_quick_start/config/settings/base.py - 3 = django_quick_start/)
...
MIGRATION_MODULES = {"sites": "django_quick_start.contrib.sites.migrations"}
...
ADMINS = [("""Awesome Developer""", "dev@example.com")]
